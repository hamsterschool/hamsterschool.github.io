(function(ext) {
	...
	const BLOCKS = {
		...
		en4: [
			...
			['-'],
			[' ', 'Hamster %n : set robot\'s marker to %n', 'setRobotMarkerTo', 0, 0],
			['w', 'Hamster %n : move %m.forward_backward to x: %n y: %n', 'moveToXY', 0, 'forward', 320, 240],
			['w', 'Hamster %n : turn in direction of x: %n y: %n', 'turnInDirectionOfXY', 0, 320, 240],
			['w', 'Hamster %n : turn in direction of %n degrees', 'turnInDirectionOfDegrees', 0, 90],
		...
		ko4: [
			...
			['-'],
			[' ', '햄스터 %n : 로봇의 마커를 %n (으)로 정하기', 'setRobotMarkerTo', 0, 0],
			['w', '햄스터 %n : %m.forward_backward x %n y %n 위치로 이동하기', 'moveToXY', 0, '앞으로', 320, 240],
			['w', '햄스터 %n : x %n y %n 방향으로 돌기', 'turnInDirectionOfXY', 0, 320, 240],
			['w', '햄스터 %n : %n 도 방향으로 돌기', 'turnInDirectionOfDegrees', 0, 90],
		...
		uz4: [
			...
			['-'],
			[' ', 'Hamster %n : robotning markerini %n ga sozlash', 'setRobotMarkerTo', 0, 0],
			['w', 'Hamster %n : %m.forward_backward x: %n y: %n tomonga yurish', 'moveToXY', 0, 'oldinga', 320, 240],
			['w', 'Hamster %n : x: %n y: %n tomonga o\'girilish', 'turnInDirectionOfXY', 0, 320, 240],
			['w', 'Hamster %n : %n daraja tomonga o\'girilish', 'turnInDirectionOfDegrees', 0, 90],
	...
	ext.setRobotMarkerTo = function(index, marker) {
		var robot = getRobot(index);
		if(robot) {
	...
	ext.moveToXY = function(index, direction, x, y, callback) {
		var robot = getRobot(index);
		if(robot) {
			x = parseInt(x);
			y = parseInt(y);
