(function(ext) {
	...
	const BLOCKS = {
		...
		ja2: [
			...
			["w", "%m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回る", "sallyTurnUnitWithRadiusInDirection", "左", 90, "度", 6, "前"],
			["-"],
			[" ", "LEDを %m.led_color にする", "sallySetLedTo", "赤色"],
			[" ", "LEDをオフにする", "sallyClearLed"],
			["-"],
		...
		ja3: [
			...
			["w", "%m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回る", "sallyTurnUnitWithRadiusInDirection", "左", 90, "度", 6, "前"],
