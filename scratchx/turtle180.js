(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			...
			["w", "%m.left_right へ回す", "turtleTurn", "左"],
			["-"],
			[" ", "頭LEDを %m.led_color にする", "turtleSetHeadLedTo", "赤色"],
			[" ", "頭LEDを消す", "turtleClearHeadLed"],
			["-"],
			[" ", "%m.sound 音を鳴らす", "turtlePlaySound", "ビープ"],
			[" ", "音を消す", "turtleClearSound"],
			["-"],
		...
		ja2: [
			...
			["w", "%m.left_right へ %n %m.deg_sec その場で回す", "turtleTurnUnitInPlace", "左", 90, "度"],
			["w", "%m.left_right 車輪を中心に %n %m.deg_sec %m.head_tail 方向へ回す", "turtlePivotAroundWheelUnitInDirection", "左", 90, "度", "頭"],
			["w", "%m.left_right へ %n %m.deg_sec 半径 %n cmを %m.head_tail 方向へ回す", "turtleTurnUnitWithRadiusInDirection", "左", 90, "度", 6, "頭"],
			["-"],
			[" ", "頭LEDを %m.led_color にする", "turtleSetHeadLedTo", "赤色"],
			[" ", "頭LEDを消す", "turtleClearHeadLed"],
			["-"],
		...
		ja3: [
			...
			["w", "%m.left_right へ %n %m.turn_unit その場で回す", "turtleTurnUnitInPlace", "左", 90, "度"],
			["w", "%m.left_right 車輪を中心に %n %m.turn_unit %m.head_tail 方向へ回す", "turtlePivotAroundWheelUnitInDirection", "左", 90, "度", "頭"],
			["w", "%m.left_right へ %n %m.turn_unit 半径 %n cmを %m.head_tail 方向へ回す", "turtleTurnUnitWithRadiusInDirection", "左", 90, "度", 6, "頭"],
			...
			["w", "黒色線を追従して %m.target_color まで移動する", "turtleFollowLineUntil", "赤色"],
			["w", "%m.color_line 線を追従して黒色まで移動する", "turtleFollowLineUntilBlack", "赤色"],
			["w", "黒色交差点を渡る", "turtleCrossIntersection"],
			["w", "黒色交差点で %m.left_right_back へ回す", "turtleTurnAtIntersection", "左"],
