(function(ext) {
	...
	const BLOCKS = {
		...
		en2: [
			...
			["w", "turn %m.left_right %n %m.deg_sec with radius %n cm in %m.forward_backward direction", "brownTurnUnitWithRadiusInDirection", "left", 90, "degrees", 3, "forward"],
			["-"],
			[" ", "set led to %m.led_color", "brownSetLedTo", "red"],
			[" ", "clear led", "brownClearLed"],
			["-"],
		...
		en3: [
			...
			["w", "turn %m.left_right %n %m.turn_unit with radius %n cm in %m.forward_backward direction", "brownTurnUnitWithRadiusInDirection", "left", 90, "degrees", 3, "forward"],
		...
		ko2: [
			...
			["w", "%m.left_right 으로 %n %m.deg_sec 반지름 %n cm를 %m.forward_backward 방향으로 돌기", "brownTurnUnitWithRadiusInDirection", "왼쪽", 90, "도", 3, "앞쪽"],
			["-"],
			[" ", "LED를 %m.led_color 으로 정하기", "brownSetLedTo", "빨간색"],
			[" ", "LED 끄기", "brownClearLed"],
			["-"],
		...
		ko3: [
			...
			["w", "%m.left_right 으로 %n %m.turn_unit 반지름 %n cm를 %m.forward_backward 방향으로 돌기", "brownTurnUnitWithRadiusInDirection", "왼쪽", 90, "도", 3, "앞쪽"],
		...
		ja2: [
			...
			["w", "%m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回す", "brownTurnUnitWithRadiusInDirection", "左", 90, "度", 3, "前"],
			["-"],
			[" ", "LEDを %m.led_color にする", "brownSetLedTo", "赤色"],
			[" ", "LEDを消す", "brownClearLed"],
			["-"],
		...
		ja3: [
			...
			["w", "%m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回す", "brownTurnUnitWithRadiusInDirection", "左", 90, "度", 3, "前"],
		...
		uz2: [
			...
			["w", "%m.left_right ga %n %m.deg_sec radius %n cm %m.forward_backward yo'nalishga o'girilish", "brownTurnUnitWithRadiusInDirection", "chap", 90, "daraja", 3, "old"],
			["-"],
			[" ", "LEDni %m.led_color ga sozlash", "brownSetLedTo", "qizil"],
			[" ", "LEDni o'chirish", "brownClearLed"],
			["-"],
		...
		uz3: [
			...
			["w", "%m.left_right ga %n %m.turn_unit radius %n cm %m.forward_backward yo'nalishga o'girilish", "brownTurnUnitWithRadiusInDirection", "chap", 90, "daraja", 3, "old"],
