(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			...
			["w", "ハムスターS %n : ボード板上で %m.left_right へ回る", "sBoardTurn", 0, "左"],
			["-"],
			["w", "ハムスターS %n : 前へ移動する", "sMoveForward", 0],
			["w", "ハムスターS %n : 後ろへ移動する", "sMoveBackward", 0],
			["w", "ハムスターS %n : %m.left_right へ回る", "sTurn", 0, "左"],
			["-"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを %m.led_color にする", "sSetLedTo", 0, "左", "赤色"],
			[" ", "ハムスターS %n : %m.left_right_both LEDをオフにする", "sClearLed", 0, "左"],
			["-"],
			[" ", "ハムスターS %n : %m.sound_effect 音を再生する", "sPlaySound", 0, "ビープ"],
			[" ", "ハムスターS %n : 音をオフにする", "sClearSound", 0],
			["-"],
		...
		ja2: [
			...
			["w", "ハムスターS %n : %m.left_right へ %n %m.deg_sec その場所で回る", "sTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ハムスターS %n : %m.left_right 車輪を中心に %n %m.deg_sec %m.forward_backward 方向へ回る", "sPivotAroundWheelUnitInDirection", 0, "左", 90, "度", "前"],
			["w", "ハムスターS %n : %m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回る", "sTurnBodyUnitWithRadiusInDirection", 0, "左", 90, "度", 5, "前"],
			["-"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを %m.led_color にする", "sSetLedTo", 0, "左", "赤色"],
			[" ", "ハムスターS %n : %m.left_right_both LEDをオフにする", "sClearLed", 0, "左"],
			["-"],
			[" ", "ハムスターS %n : %m.sound_effect 音を %n 回再生する", "sPlaySoundTimes", 0, "ビープ", 1],
			["w", "ハムスターS %n : %m.sound_effect 音を %n 回再生して待つ", "sPlaySoundTimesUntilDone", 0, "ビープ", 1],
			[" ", "ハムスターS %n : 音をオフにする", "sClearSound", 0],
			["w", "ハムスターS %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "sPlayNoteFor", 0, "ド", "4", 0.5],
			["w", "ハムスターS %n : %d.beats 拍子止める", "sRestFor", 0, 0.25],
			[" ", "ハムスターS %n : 演奏の速さを %n ずつ変える", "sChangeTempoBy", 0, 20],
			[" ", "ハムスターS %n : 演奏の速さを %n BPMにする", "sSetTempoTo", 0, 60],
			["-"],
			["h", "ハムスターS %n : 手を見つけたとき", "sWhenHandFound", 0],
		...
		ja3: [
			...
			["w", "ハムスターS %n : %m.left_right へ %n %m.turn_unit その場所で回る", "sTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ハムスターS %n : %m.pen_wheel を中心に %n %m.turn_unit %m.forward_backward 方向へ回る", "sPivotAroundUnitInDirection", 0, "左ペン", 90, "度", "前"],
			["w", "ハムスターS %n : %m.pen_body %m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回る", "sTurnUnitWithRadiusInDirection", 0, "左ペン", "左", 90, "度", 5, "前"],
			...
			[" ", "ハムスターS %n : %m.black_white 線に沿って %m.left_right_both 床底センサーで移動する", "sFollowLineUsingFloorSensor", 0, "黒色", "左"],
			["w", "ハムスターS %n : %m.black_white 線に沿って %m.left_right_front_rear 交差点まで移動する", "sFollowLineUntilIntersection", 0, "黒色", "前"],
			[" ", "ハムスターS %n : 線に沿って移動する速さを %m.speed にする", "sSetFollowingSpeedTo", 0, "5"],
			[" ", "ハムスターS %n : 線に沿って移動する方向変化量を %m.gain にする", "sSetFollowingGainTo", 0, "基本値"],
			...
			[" ", "ハムスターS %n : 音をオフにする", "sClearSound", 0],
			[" ", "ハムスターS %n : %m.note %m.octave 音を奏でる", "sPlayNote", 0, "ド", "4"],
			["w", "ハムスターS %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "sPlayNoteFor", 0, "ド", "4", 0.5],
			["w", "ハムスターS %n : %d.beats 拍子止める", "sRestFor", 0, 0.25],
			[" ", "ハムスターS %n : 演奏の速さを %n ずつ変える", "sChangeTempoBy", 0, 20],
			[" ", "ハムスターS %n : 演奏の速さを %n BPMにする", "sSetTempoTo", 0, 60],
			...
			["r", "ハムスターS %n : 左床底センサー", "sLeftFloor", 0],
			["r", "ハムスターS %n : 右床底センサー", "sRightFloor", 0],
			...
			["b", "ハムスターS %n : 手を見つけたか?", "sHandFound", 0],
			["b", "ハムスターS %n : %m.s_tilt ?", "sTilt", 0, "前に傾けたか"],
			["b", "ハムスターS %n : 電池充電が %m.battery ?", "sBattery", 0, "正常か"],
			["-"],
			...
			[" ", "ハムスターS %n : グリッパをオフにする", "sReleaseGripper", 0],
	...
	const MENUS = {
		...
		ja: {
			...
			"octave": ["1", "2", "3", "4", "5", "6", "7"],
			"beats": ["¼", "½", "¾", "1", "1¼", "1½", "1¾", "2", "3", "4"],
			"when_tilt": ["前に傾けた", "後に傾けた", "左に傾けた", "右に傾けた", "上下裏返した", "傾いてなかった"],
			"tilt": ["前に傾けたか", "後に傾けたか", "左に傾けたか", "右に傾けたか", "上下裏返したか", "傾いてないか"],
			...
			"sound": ["ビープ", "ランダムビープ", "サイレン", "エンジン", "ロボット", "行進", "誕生", "ディバディバディップ", "よくできました"],
