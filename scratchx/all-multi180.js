(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			...
			["w", "ハムスター %n : ボード板上で %m.left_right へ回す", "boardTurn", 0, "左"],
			["-"],
			["w", "ハムスター %n : 前へ移動する", "moveForward", 0],
			["w", "ハムスター %n : 後ろへ移動する", "moveBackward", 0],
			["w", "ハムスター %n : %m.left_right へ回す", "turn", 0, "左"],
			["-"],
			[" ", "ハムスター %n : %m.left_right_both LEDを %m.color にする", "setLedTo", 0, "左", "赤色"],
			[" ", "ハムスター %n : %m.left_right_both LEDを消す", "clearLed", 0, "左"],
			["-"],
			...
			["-"],
			["-"],
			["w", "ハムスターS %n : ボード板上で前へ移動する", "sBoardMoveForward", 0],
			["w", "ハムスターS %n : ボード板上で %m.left_right へ回す", "sBoardTurn", 0, "左"],
			["-"],
			["w", "ハムスターS %n : 前へ移動する", "sMoveForward", 0],
			["w", "ハムスターS %n : 後ろへ移動する", "sMoveBackward", 0],
			["w", "ハムスターS %n : %m.left_right へ回す", "sTurn", 0, "左"],
			["-"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを %m.led_color にする", "sSetLedTo", 0, "左", "赤色"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを消す", "sClearLed", 0, "左"],
			["-"],
			[" ", "ハムスターS %n : %m.sound_effect 音を鳴らす", "sPlaySound", 0, "ビープ"],
			[" ", "ハムスターS %n : 音を消す", "sClearSound", 0],
			["-"],
			...
			["w", "カメ %n : %m.left_right へ回す", "turtleTurn", 0, "左"],
			["-"],
			[" ", "カメ %n : 頭LEDを %m.led_color にする", "turtleSetHeadLedTo", 0, "赤色"],
			[" ", "カメ %n : 頭LEDを消す", "turtleClearHeadLed", 0],
			["-"],
			[" ", "カメ %n : %m.sound 音を鳴らす", "turtlePlaySound", 0, "ビープ"],
			[" ", "カメ %n : 音を消す", "turtleClearSound", 0],
			["-"],
		...
		ja2: [
			...
			["w", "ハムスター %n : %m.left_right へ %n 秒回す", "turnForSecs", 0, "左", 1],
			["-"],
			[" ", "ハムスター %n : %m.left_right_both LEDを %m.color にする", "setLedTo", 0, "左", "赤色"],
			[" ", "ハムスター %n : %m.left_right_both LEDを消す", "clearLed", 0, "左"],
			["-"],
			...
			["w", "ハムスターS %n : ボード板上で %m.left_right へ回す", "sBoardTurn", 0, "左"],
			["-"],
			["w", "ハムスターS %n : 前へ %n %m.cm_sec 移動する", "sMoveForwardUnit", 0, 5, "cm"],
			["w", "ハムスターS %n : 後ろへ %n %m.cm_sec 移動する", "sMoveBackwardUnit", 0, 5, "cm"],
			["w", "ハムスターS %n : %m.left_right へ %n %m.deg_sec その場で回す", "sTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ハムスターS %n : %m.left_right 車輪を中心に %n %m.deg_sec %m.forward_backward 方向へ回す", "sPivotAroundWheelUnitInDirection", 0, "左", 90, "度", "前"],
			["w", "ハムスターS %n : %m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回す", "sTurnBodyUnitWithRadiusInDirection", 0, "左", 90, "度", 5, "前"],
			["-"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを %m.led_color にする", "sSetLedTo", 0, "左", "赤色"],
			[" ", "ハムスターS %n : %m.left_right_both LEDを消す", "sClearLed", 0, "左"],
			["-"],
			...
			["w", "カメ %n : %m.left_right へ %n %m.deg_sec その場で回す", "turtleTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "カメ %n : %m.left_right 車輪を中心に %n %m.deg_sec %m.head_tail 方向へ回す", "turtlePivotAroundWheelUnitInDirection", 0, "左", 90, "度", "頭"],
			["w", "カメ %n : %m.left_right へ %n %m.deg_sec 半径 %n cmを %m.head_tail 方向へ回す", "turtleTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "頭"],
			["-"],
			[" ", "カメ %n : 頭LEDを %m.led_color にする", "turtleSetHeadLedTo", 0, "赤色"],
			[" ", "カメ %n : 頭LEDを消す", "turtleClearHeadLed", 0],
			["-"],
		...
		ja3: [
			...
			["w", "ハムスター %n : %m.black_white 線を追従して %m.left_right_front_rear 交差点まで移動する", "followLineUntilIntersection", 0, "黒色", "前"],
			...
			[" ", "ハムスター %n : グリッパを消す", "releaseGripper", 0],
			...
			["w", "ハムスターS %n : ボード板上で %m.left_right へ回す", "sBoardTurn", 0, "左"],
			["-"],
			["w", "ハムスターS %n : 前へ %n %m.move_unit 移動する", "sMoveForwardUnit", 0, 5, "cm"],
			["w", "ハムスターS %n : 後ろへ %n %m.move_unit 移動する", "sMoveBackwardUnit", 0, 5, "cm"],
			["w", "ハムスターS %n : %m.left_right へ %n %m.turn_unit その場で回す", "sTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ハムスターS %n : %m.pen_wheel を中心に %n %m.turn_unit %m.forward_backward 方向へ回す", "sPivotAroundUnitInDirection", 0, "左ペン", 90, "度", "前"],
			["w", "ハムスターS %n : %m.pen_body %m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回す", "sTurnUnitWithRadiusInDirection", 0, "左ペン", "左", 90, "度", 5, "前"],
			...
			["w", "ハムスターS %n : %m.black_white 線を追従して %m.left_right_front_rear 交差点まで移動する", "sFollowLineUntilIntersection", 0, "黒色", "前"],
			...
			[" ", "ハムスターS %n : グリッパを消す", "sReleaseGripper", 0],
			...
			["w", "カメ %n : %m.left_right へ %n %m.turn_unit その場で回す", "turtleTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "カメ %n : %m.left_right 車輪を中心に %n %m.turn_unit %m.head_tail 方向へ回す", "turtlePivotAroundWheelUnitInDirection", 0, "左", 90, "度", "頭"],
			["w", "カメ %n : %m.left_right へ %n %m.turn_unit 半径 %n cmを %m.head_tail 方向へ回す", "turtleTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "頭"],
			...
			["w", "カメ %n : 黒色線を追従して %m.target_color まで移動する", "turtleFollowLineUntil", 0, "赤色"],
			["w", "カメ %n : %m.color_line 線を追従して黒色まで移動する", "turtleFollowLineUntilBlack", 0, "赤色"],
			["w", "カメ %n : 黒色交差点を渡る", "turtleCrossIntersection", 0],
			["w", "カメ %n : 黒色交差点で %m.left_right_back へ回す", "turtleTurnAtIntersection", 0, "左"],
		...
		uz3: [
			...
			[" ", "HamsterS %n : ketma-ket tezligini %m.serial_baud Bd ga sozlash", "sSetSerialRateTo", 0, "9600"],
