(function(ext) {
	...
	const BLOCKS = {
		...
		ja2: [
			...
			["w", "%m.left_right 車輪を中心に %n %m.deg_sec %m.forward_backward 方向へ回す", "uoPivotAroundWheelUnitInDirection", "左", 90, "度", "前"],
			["-"],
			[" ", "%m.left_right_both 眼を %m.led_color にする", "uoSetEyeTo", "左", "赤色"],
			[" ", "%m.left_right_both 眼を消す", "uoClearEye", "左"],
			["-"],
		...
		ja3: [
			...
			["w", "%m.left_right 車輪を中心に %n %m.turn_unit %m.forward_backward 方向へ回す", "uoPivotAroundWheelUnitInDirection", "左", 90, "度", "前"],
