(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			...
			["w", "ボード板上で %m.left_right へ回す", "boardTurn", "左"],
			["-"],
			...
			[" ", "%m.left_right_both LEDを消す", "clearLed", "左"],
			["-"],
			["w", "ビープ", "beep"],
			["-"],
		...
		ja3: [
			...
			["w", "%m.black_white 線を追従して %m.left_right_front_rear 交差点まで移動する", "followLineUntilIntersection", "黒色", "前"],
