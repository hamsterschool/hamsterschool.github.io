(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			["w", "ボード板上で前へ移動する", "boardMoveForward"],
			["w", "ボード板上で %m.left_right へ回る", "boardTurn", "左"],
			["-"],
			["w", "前へ移動する", "moveForward"],
			["w", "後ろへ移動する", "moveBackward"],
			["w", "%m.left_right へ回る", "turn", "左"],
			["-"],
			[" ", "%m.left_right_both LEDを %m.color にする", "setLedTo", "左", "赤色"],
			[" ", "%m.left_right_both LEDをオフにする", "clearLed", "左"],
			["-"],
			["w", "ビープ", "beep"],
			["-"],
		...
		ja2: [
			...
			["w", "ボード板上で %m.left_right へ回る", "boardTurn", "左"],
			["-"],
			["w", "前へ %n 秒移動する", "moveForwardForSecs", 1],
			["w", "後ろへ %n 秒移動する", "moveBackwardForSecs", 1],
			["w", "%m.left_right へ %n 秒回る", "turnForSecs", "左", 1],
			["-"],
			[" ", "%m.left_right_both LEDを %m.color にする", "setLedTo", "左", "赤色"],
			[" ", "%m.left_right_both LEDをオフにする", "clearLed", "左"],
			["-"],
			["w", "ビープ", "beep"],
			["w", "%m.note %m.octave 音を %d.beats 拍子奏でる", "playNoteFor", "ド", "4", 0.5],
			["w", "%d.beats 拍子止める", "restFor", 0.25],
			[" ", "演奏の速さを %n ずつ変える", "changeTempoBy", 20],
			[" ", "演奏の速さを %n BPMにする", "setTempoTo", 60],
			["-"],
			["h", "手を見つけたとき", "whenHandFound"],
		...
		ja3: [
			...
			[" ", "%m.black_white 線に沿って %m.left_right_both 床底センサーで移動する", "followLineUsingFloorSensor", "黒色", "左"],
			["w", "%m.black_white 線に沿って %m.left_right_front_rear 交差点まで移動する", "followLineUntilIntersection", "黒色", "前"],
			[" ", "線に沿って移動する速さを %m.speed にする", "setFollowingSpeedTo", "5"],
			[" ", "停止する", "stop"],
			["-"],
			[" ", "%m.left_right_both LEDを %m.color にする", "setLedTo", "左", "赤色"],
			[" ", "%m.left_right_both LEDをオフにする", "clearLed", "左"],
			...
			[" ", "ブザー音をオフにする", "clearBuzzer"],
			[" ", "%m.note %m.octave 音を奏でる", "playNote", "ド", "4"],
			["w", "%m.note %m.octave 音を %d.beats 拍子奏でる", "playNoteFor", "ド", "4", 0.5],
			["w", "%d.beats 拍子止める", "restFor", 0.25],
			[" ", "演奏の速さを %n ずつ変える", "changeTempoBy", 20],
			[" ", "演奏の速さを %n BPMにする", "setTempoTo", 60],
