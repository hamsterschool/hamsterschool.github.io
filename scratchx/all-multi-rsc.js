(function(ext) {
	...
	const BLOCKS = {
		...
		en4: [
			...
			['-'],
			[' ', '%m.robots %n : set robot\'s marker to %n', 'robotSetRobotMarkerTo', 'Hamster', 0, 0],
			['w', '%m.robots %n : move %m.forward_backward to x: %n y: %n', 'robotMoveToXY', 'Hamster', 0, 'forward', 320, 240],
			['w', '%m.robots %n : turn in direction of x: %n y: %n', 'robotTurnInDirectionOfXY', 'Hamster', 0, 320, 240],
			['w', '%m.robots %n : turn in direction of %n degrees', 'robotTurnInDirectionOfDegrees', 'Hamster', 0, 90],
