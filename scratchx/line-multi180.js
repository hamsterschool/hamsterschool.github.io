(function(ext) {
	...
	const BLOCKS = {
		...
		en2: [
			...
			["w", "Brown·Sally %n : turn %m.left_right %n %m.deg_sec with radius %n cm in %m.forward_backward direction", "lineTurnUnitWithRadiusInDirection", 0, "left", 90, "degrees", 6, "forward"],
			["-"],
			[" ", "Brown·Sally %n : set led to %m.led_color", "lineSetLedTo", 0, "red"],
			[" ", "Brown·Sally %n : clear led", "lineClearLed", 0],
			["-"],
		...
		en3: [
			...
			["w", "Brown·Sally %n : turn %m.left_right %n %m.turn_unit with radius %n cm in %m.forward_backward direction", "lineTurnUnitWithRadiusInDirection", 0, "left", 90, "degrees", 6, "forward"],
		...
		ko2: [
			...
			["w", "브라운·샐리 %n : %m.left_right 으로 %n %m.deg_sec 반지름 %n cm를 %m.forward_backward 방향으로 돌기", "lineTurnUnitWithRadiusInDirection", 0, "왼쪽", 90, "도", 6, "앞쪽"],
			["-"],
			[" ", "브라운·샐리 %n : LED를 %m.led_color 으로 정하기", "lineSetLedTo", 0, "빨간색"],
			[" ", "브라운·샐리 %n : LED 끄기", "lineClearLed", 0],
			["-"],
		...
		ko3: [
			...
			["w", "브라운·샐리 %n : %m.left_right 으로 %n %m.turn_unit 반지름 %n cm를 %m.forward_backward 방향으로 돌기", "lineTurnUnitWithRadiusInDirection", 0, "왼쪽", 90, "도", 6, "앞쪽"],
		...
		ja1: [
			...
			["w", "ブラウン·サリー %n : %m.left_right へ回る", "lineTurn", 0, "左"],
			["-"],
			[" ", "ブラウン·サリー %n : LEDを %m.led_color にする", "lineSetLedTo", 0, "赤色"],
			[" ", "ブラウン·サリー %n : LEDをオフにする", "lineClearLed", 0],
			["-"],
			[" ", "ブラウン·サリー %n : %m.sound_effect 音を再生する", "linePlaySound", 0, "ビープ"],
			[" ", "ブラウン·サリー %n : 音をオフにする", "lineClearSound", 0],
			["-"],
		...
		ja2: [
			...
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.deg_sec その場所で回る", "lineTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ブラウン·サリー %n : %m.left_right 車輪を中心に %n %m.deg_sec %m.forward_backward 方向へ回る", "linePivotAroundWheelUnitInDirection", 0, "左", 90, "度", "前"],
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回る", "lineTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "前"],
			["-"],
			[" ", "ブラウン·サリー %n : LEDを %m.led_color にする", "lineSetLedTo", 0, "赤色"],
			[" ", "ブラウン·サリー %n : LEDをオフにする", "lineClearLed", 0],
			["-"],
			[" ", "ブラウン·サリー %n : %m.sound_effect 音を %n 回再生する", "linePlaySoundTimes", 0, "ビープ", 1],
			["w", "ブラウン·サリー %n : %m.sound_effect 音を %n 回再生して待つ", "linePlaySoundTimesUntilDone", 0, "ビープ", 1],
			[" ", "ブラウン·サリー %n : 音をオフにする", "lineClearSound", 0],
			["w", "ブラウン·サリー %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "linePlayNoteForBeats", 0, "ド", "4", 0.5],
			["w", "ブラウン·サリー %n : %d.beats 拍子止める", "lineRestForBeats", 0, 0.25],
			[" ", "ブラウン·サリー %n : 演奏の速さを %n ずつ変える", "lineChangeTempoBy", 0, 20],
			[" ", "ブラウン·サリー %n : 演奏の速さを %n BPMにする", "lineSetTempoTo", 0, 60],
			["-"],
			["h", "ブラウン·サリー %n : %m.touching_color に触れたとき", "lineWhenColorTouched", 0, "赤色"],
		...
		ja3: [
			...
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.turn_unit その場所で回る", "lineTurnUnitInPlace", 0, "左", 90, "度"],
			["w", "ブラウン·サリー %n : %m.left_right 車輪を中心に %n %m.turn_unit %m.forward_backward 方向へ回る", "linePivotAroundWheelUnitInDirection", 0, "左", 90, "度", "前"],
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回る", "lineTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "前"],
			...
			[" ", "ブラウン·サリー %n : 線に沿って移動する速さを %m.speed にする", "lineSetFollowingSpeedTo", 0, "4"],
			...
			[" ", "ブラウン·サリー %n : 音をオフにする", "lineClearSound", 0],
			[" ", "ブラウン·サリー %n : %m.note %m.octave 音を奏でる", "linePlayNote", 0, "ド", "4"],
			["w", "ブラウン·サリー %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "linePlayNoteForBeats", 0, "ド", "4", 0.5],
			["w", "ブラウン·サリー %n : %d.beats 拍子止める", "lineRestForBeats", 0, 0.25],
			[" ", "ブラウン·サリー %n : 演奏の速さを %n ずつ変える", "lineChangeTempoBy", 0, 20],
			[" ", "ブラウン·サリー %n : 演奏の速さを %n BPMにする", "lineSetTempoTo", 0, 60],
			...
			["r", "ブラウン·サリー %n : 床底センサー", "lineFloor", 0],
			...
			["b", "ブラウン·サリー %n : ボタンを %m.button_state ?", "lineButtonState", 0, "クリックしたか"],
			["b", "ブラウン·サリー %n : %m.s_tilt ?", "lineTilt", 0, "前に傾けたか"],
			["b", "ブラウン·サリー %n : 電池充電が %m.battery ?", "lineBattery", 0, "正常か"]
		],
		uz1: [
		...
		uz2: [
			...
			["w", "Brown·Sally %n : %m.left_right ga %n %m.deg_sec radius %n cm %m.forward_backward yo'nalishga o'girilish", "lineTurnUnitWithRadiusInDirection", 0, "chap", 90, "daraja", 6, "old"],
			["-"],
			[" ", "Brown·Sally %n : LEDni %m.led_color ga sozlash", "lineSetLedTo", 0, "qizil"],
			[" ", "Brown·Sally %n : LEDni o'chirish", "lineClearLed", 0],
			["-"],
		...
		uz3: [
			...
			["w", "Brown·Sally %n : %m.left_right ga %n %m.turn_unit radius %n cm %m.forward_backward yo'nalishga o'girilish", "lineTurnUnitWithRadiusInDirection", 0, "chap", 90, "daraja", 6, "old"],
	...
	const MENUS = {
		...
		ja: {
			...
			"when_s_tilt": ["前に傾けた", "後に傾けた", "左に傾けた", "右に傾けた", "上下裏返した", "傾いてなかった", "叩いた", "自由落下した"],
			"button_state": ["クリックしたか", "ダブルクリックしたか", "長く押したか"],
			"s_tilt": ["前に傾けたか", "後に傾けたか", "左に傾けたか", "右に傾けたか", "上下裏返したか", "傾いてないか", "叩いたか", "自由落下したか"],
