(function(ext) {
	...
	const BLOCKS = {
		...
		ja2: [
			...
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.deg_sec 半径 %n cmを %m.forward_backward 方向へ回す", "lineTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "前"],
			["-"],
			[" ", "ブラウン·サリー %n : LEDを %m.led_color にする", "lineSetLedTo", 0, "赤色"],
			[" ", "ブラウン·サリー %n : LEDを消す", "lineClearLed", 0],
			["-"],
		...
		ja3: [
			...
			["w", "ブラウン·サリー %n : %m.left_right へ %n %m.turn_unit 半径 %n cmを %m.forward_backward 方向へ回す", "lineTurnUnitWithRadiusInDirection", 0, "左", 90, "度", 6, "前"],
