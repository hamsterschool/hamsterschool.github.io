class MachineLearningText {
    ...
    getInfo() {
        ...
        return {
            ...
            id: 'mlforkidstext115b0af08c6b11ea92f8f7a0b900a81b',
...
//            blockIconURI: this._icon,
    ...
    addTraining({ TEXT, LABEL }) {
        ...
        var url = new URL('https://machinelearningforkids.co.uk/api/scratch/3242f660-8c6b-11ea-92f8-f7a0b900a81b6ab70d74-dba7-4353-ac40-3a1aa815a364/train');
...
function classifyText(text, cacheKey, lastmodified, callback) {
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/3242f660-8c6b-11ea-92f8-f7a0b900a81b6ab70d74-dba7-4353-ac40-3a1aa815a364/classify');
...
function trainNewClassifier() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/3242f660-8c6b-11ea-92f8-f7a0b900a81b6ab70d74-dba7-4353-ac40-3a1aa815a364/models');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
...
function fetchStatus() {
    ...
    var url = new URL('https://machinelearningforkids.co.uk/api/scratch/3242f660-8c6b-11ea-92f8-f7a0b900a81b6ab70d74-dba7-4353-ac40-3a1aa815a364/status');
    var options = {
        headers : {
            'Accept': 'application/json',
            'Content-Type': 'application/json',
