(function(ext) {
	...
	const BLOCKS = {
		...
		ja1: [
			["w", "ゼロワン %n : 前へ移動する", "zeroneMoveForward", 0],
			["w", "ゼロワン %n : 後ろへ移動する", "zeroneMoveBackward", 0],
			["w", "ゼロワン %n : %m.left_right へ回る", "zeroneTurn", 0, "左"],
			["-"],
			[" ", "ゼロワン %n : %m.left_right_head_tail_all LEDを %m.led_color にする", "zeroneSetLedTo", 0, "前", "赤色"],
			[" ", "ゼロワン %n : %m.left_right_head_tail_all LEDをオフにする", "zeroneClearLed", 0, "前"],
			["-"],
			[" ", "ゼロワン %n : %m.sound_effect 音を再生する", "zeronePlaySound", 0, "ビープ"],
			[" ", "ゼロワン %n : 音をオフにする", "zeroneClearSound", 0],
			["-"],
		...
		ja2: [
			["w", "ゼロワン %n : 前へ %n %m.cm_sec 移動する", "zeroneMoveForwardUnit", 0, 6.5, "cm"],
			["w", "ゼロワン %n : 後ろへ %n %m.cm_sec 移動する", "zeroneMoveBackwardUnit", 0, 6.5, "cm"],
			["w", "ゼロワン %n : %m.left_right へ %n %m.deg_sec その場所で回る", "zeroneTurnUnitInPlace", 0, "左", 90, "度"],
			["-"],
			[" ", "ゼロワン %n : %m.left_right_head_tail_all LEDを %m.led_color にする", "zeroneSetLedTo", 0, "前", "赤色"],
			[" ", "ゼロワン %n : %m.left_right_head_tail_all LEDをオフにする", "zeroneClearLed", 0, "前"],
			["-"],
			[" ", "ゼロワン %n : %m.sound_effect 音を %n 回再生する", "zeronePlaySoundTimes", 0, "ビープ", 1],
			["w", "ゼロワン %n : %m.sound_effect 音を %n 回再生して待つ", "zeronePlaySoundTimesUntilDone", 0, "ビープ", 1],
			[" ", "ゼロワン %n : 音をオフにする", "zeroneClearSound", 0],
			["w", "ゼロワン %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "zeronePlayNoteFor", 0, "ド", "4", 0.5],
			["w", "ゼロワン %n : %d.beats 拍子止める", "zeroneRestFor", 0, 0.25],
			[" ", "ゼロワン %n : 演奏の速さを %n ずつ変える", "zeroneChangeTempoBy", 0, 20],
			[" ", "ゼロワン %n : 演奏の速さを %n BPMにする", "zeroneSetTempoTo", 0, 60],
			["-"],
			[" ", "ゼロワン %n : %m.zerone_sensor_mode センサーを開始する", "zeroneStartSensor", 0, "ジェスチャー"],
			["h", "ゼロワン %n : ジェスチャーが %m.gesture であるとき", "zeroneWhenGesture", 0, "前へ"],
			["h", "ゼロワン %n : %m.zerone_color に触れたとき", "zeroneWhenColorTouched", 0, "赤色"],
		...
		ja3: [
			["w", "ゼロワン %n : 前へ %n %m.move_unit 移動する", "zeroneMoveForwardUnit", 0, 6.5, "cm"],
			["w", "ゼロワン %n : 後ろへ %n %m.move_unit 移動する", "zeroneMoveBackwardUnit", 0, 6.5, "cm"],
			["w", "ゼロワン %n : %m.left_right へ %n %m.turn_unit その場所で回る", "zeroneTurnUnitInPlace", 0, "左", 90, "度"],
			...
			[" ", "ゼロワン %n : 音をオフにする", "zeroneClearSound", 0],
			[" ", "ゼロワン %n : %m.note %m.octave 音を奏でる", "zeronePlayNote", 0, "ド", "4"],
			["w", "ゼロワン %n : %m.note %m.octave 音を %d.beats 拍子奏でる", "zeronePlayNoteFor", 0, "ド", "4", 0.5],
			["w", "ゼロワン %n : %d.beats 拍子止める", "zeroneRestFor", 0, 0.25],
			[" ", "ゼロワン %n : 演奏の速さを %n ずつ変える", "zeroneChangeTempoBy", 0, 20],
			[" ", "ゼロワン %n : 演奏の速さを %n BPMにする", "zeroneSetTempoTo", 0, 60],
			...
			["b", "ゼロワン %n : ジェスチャーが %m.gesture ですか?", "zeroneIsGesture", 0, "前へ"],
			["b", "ゼロワン %n : %m.zerone_color に触れたか?", "zeroneTouchingColor", 0, "赤色"],
			["b", "ゼロワン %n : 電池充電が %m.battery ?", "zeroneBattery", 0, "正常か"]
		],
		uz1: [
